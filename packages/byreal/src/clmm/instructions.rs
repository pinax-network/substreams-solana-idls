//! Byreal CLMM on-chain instructions.
...
// -----------------------------------------------------------------------------
impl<'a> TryFrom<&'a [u8]> for ByrealClmmInstruction {
...
pub fn unpack(data: &[u8]) -> Result<ByrealClmmInstruction, ParseError> {
    ByrealClmmInstruction::try_from(data)
}
