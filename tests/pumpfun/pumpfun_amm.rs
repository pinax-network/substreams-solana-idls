...
mod tests {
    ...
    fn unpack_sell_event_v2() {
        ...
        match substreams_solana_idls::pumpfun::amm::events::unpack(&bytes).expect("decode event") {
            substreams_solana_idls::pumpfun::amm::events::PumpFunAmmEvent::SellEventV2(event) => {
    ...
    fn unpack_buy_event_v2() {
        ...
        match substreams_solana_idls::pumpfun::amm::events::unpack(&bytes).expect("decode event") {
            substreams_solana_idls::pumpfun::amm::events::PumpFunAmmEvent::BuyEventV2(event) => {
                assert_eq!(event.timestamp, 1751467333, "timestamp");
    ...
    fn unpack_buy_instruction() {
        ...
        match substreams_solana_idls::pumpfun::amm::instructions::unpack(&bytes).expect("decode instruction") {
            substreams_solana_idls::pumpfun::amm::instructions::PumpFunAmmInstruction::Buy(event) => {
                assert_eq!(event.base_amount_out, 39496040, "base_amount_out");
                assert_eq!(event.max_quote_amount_in, 45010660347, "max_quote_amount_in");
            }
    ...
    fn unpack_sell_instruction() {
        ...
        match substreams_solana_idls::pumpfun::amm::instructions::unpack(&bytes).expect("decode instruction") {
            substreams_solana_idls::pumpfun::amm::instructions::PumpFunAmmInstruction::Sell(event) => {
                assert_eq!(event.base_amount_in, 82847919, "base_amount_in");
                assert_eq!(event.min_quote_amount_out, 88833132348, "min_quote_amount_out");
            }
            _ => panic!("Expected a BuyInstruction"),
    ...
    fn unpack_create_pool_v2_instruction() {
        ...
        match substreams_solana_idls::pumpfun::amm::instructions::unpack(&bytes).expect("decode instruction") {
            substreams_solana_idls::pumpfun::amm::instructions::PumpFunAmmInstruction::CreatePoolV2(event) => {
    ...
    fn unpack_create_pool_v2_event() {
        ...
        match substreams_solana_idls::pumpfun::amm::events::unpack(&bytes).expect("decode event") {
            substreams_solana_idls::pumpfun::amm::events::PumpFunAmmEvent::CreatePoolEventV2(event) => {
