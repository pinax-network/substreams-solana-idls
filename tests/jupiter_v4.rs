...
mod tests {
    ...
    fn unpack_v4_swap_event() {
        ...
        match jupiter::v4::anchor_self_cpi::unpack(&bytes).expect("decode jupiterEvent") {
            jupiter::v4::anchor_self_cpi::JupiterV4Event::Swap(event) => {
                assert_eq!(
                    event,
                    jupiter::v4::anchor_self_cpi::SwapEvent {
