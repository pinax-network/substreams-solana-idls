...
mod tests {
    ...
    fn unpack_v6_swap_event() {
        ...
        match jupiter::v6::anchor_self_cpi::unpack(&bytes).expect("decode jupiterEvent") {
            jupiter::v6::anchor_self_cpi::JupiterV6Event::Swap(event) => {
                assert_eq!(
                    event,
                    jupiter::v6::anchor_self_cpi::SwapEvent {
    ...
    fn unpack_v6_swap_fee_event() {
        ...
        match jupiter::v6::anchor_self_cpi::unpack(&bytes).expect("decode jupiterEvent") {
            jupiter::v6::anchor_self_cpi::JupiterV6Event::Fee(event) => {
                assert_eq!(
                    event,
                    jupiter::v6::anchor_self_cpi::FeeEvent {
