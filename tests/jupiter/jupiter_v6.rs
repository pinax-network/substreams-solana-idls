...
mod tests {
    ...
    fn unpack_v6_swap_event() {
        ...
        match substreams_solana_idls::jupiter::v6::events::unpack(&bytes).expect("decode jupiterEvent") {
            substreams_solana_idls::jupiter::v6::events::JupiterV6Event::Swap(event) => {
                assert_eq!(
                    event,
                    substreams_solana_idls::jupiter::v6::events::SwapEvent {
    ...
    fn unpack_v6_swap_fee_event() {
        ...
        match substreams_solana_idls::jupiter::v6::events::unpack(&bytes).expect("decode jupiterEvent") {
            substreams_solana_idls::jupiter::v6::events::JupiterV6Event::Fee(event) => {
                assert_eq!(
                    event,
                    substreams_solana_idls::jupiter::v6::events::FeeEvent {
