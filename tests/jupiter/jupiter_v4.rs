...
mod tests {
    ...
    fn unpack_v4_swap_event() {
        ...
        match substreams_solana_idls::jupiter::v4::events::unpack(&bytes).expect("decode jupiterEvent") {
            substreams_solana_idls::jupiter::v4::events::JupiterV4Event::Swap(event) => {
                assert_eq!(
                    event,
                    substreams_solana_idls::jupiter::v4::events::SwapEvent {
