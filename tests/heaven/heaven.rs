...
mod tests {
    use base64::Engine;
    use substreams::hex;
    use substreams_solana_idls::heaven;
    ...
    fn unpack_sell_instruction() {
        ...
        match substreams_solana_idls::heaven::instructions::unpack(&bytes).expect("decode instruction") {
            substreams_solana_idls::heaven::instructions::HeavenInstruction::Sell(ix) => {
    ...
    fn unpack_sell_log() {
        ...
        match substreams_solana_idls::heaven::logs::unpack(&bytes).expect("decode log") {
            substreams_solana_idls::heaven::logs::HeavenLog::Sell(log) => {
