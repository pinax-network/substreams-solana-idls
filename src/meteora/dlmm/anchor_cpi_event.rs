...
pub enum MeteoraDlmmAnchorCpiEvent {
    Swap(SwapEvent),
    // AddLiquidity,
    // ClaimFee,
    // ClaimFee2,
...
// -----------------------------------------------------------------------------
impl<'a> TryFrom<&'a [u8]> for MeteoraDlmmAnchorCpiEvent {
...
pub fn unpack(data: &[u8]) -> Result<MeteoraDlmmAnchorCpiEvent, ParseError> {
    MeteoraDlmmAnchorCpiEvent::try_from(data)
}
